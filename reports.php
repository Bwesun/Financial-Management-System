...
<tr>
    <td colspan="8">
        <h4><strong><font color="green">Summary</font></strong><br>
        <font color="green"><strong>Total Revenue: ₦ <?php echo number_format($total_income); ?></strong><br>
        <strong>Total Expenses: ₦ <?php echo number_format($total_expense); ?></strong><br>
        <strong>Balance: ₦ <?php echo number_format($balance); ?></strong></font></h4>
    </td>
</tr>
                    </table>
...
<h3>
    <font color="maroon">
        ...
        Account Number: <?php $acct_name=$brows['name'];  echo $brows['acct_number'];  ?><br>
...
<tr>
    <td colspan="7">
        <h4><strong><font color="maroon">Summary</font></strong><br>
        <font color="maroon">Total Revenue: ₦ <?php echo number_format($total_income); ?><br>
        Total Expenses: ₦ <?php echo number_format($total_expense); ?><br>
        Balance: ₦ <?php echo number_format($balance); ?></font></h4>
    </td>
</tr>
</table>
<b><hr></b>
...
<tr>
    <td colspan="8">
        <h4><strong><font color="blue">Overall Balance: </font></strong><br>
        <font color="blue"><strong>₦ <?php echo number_format($balance); ?></strong></font></h4>
    </td>
</tr>
                    </table>
